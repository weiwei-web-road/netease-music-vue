...
export const INCREMENT = 'LLL_INCREMENT';
export const FILTER = 'WW_FILTER';
...
export const SET_MY_PLAYLIST_DETAIL = 'HOME_SET_MY_PLAYLIST_DETAIL';
export const SET_PLAYING_SONG = 'SET_PLAYING_SONG';
export const SET_IS_PLAYING = 'SET_IS_PLAYING';
export const SET_LYRIC = 'SET_LYRIC';
export const SET_RECOMMAND_ALBUMS = 'SET_RECOMMAND_ALBUMS';
